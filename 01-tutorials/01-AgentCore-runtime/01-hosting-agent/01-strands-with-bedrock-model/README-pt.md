# Hospedando Strands Agents com modelos do Amazon Bedrock no Amazon Bedrock AgentCore Runtime

## Visão Geral

Neste tutorial, aprenderemos como hospedar seu agente existente usando o Amazon Bedrock AgentCore Runtime. 

Focaremos em um exemplo de Strands Agents com modelo do Amazon Bedrock. Para LangGraph com modelo do Amazon Bedrock, consulte [aqui](../02-langgraph-with-bedrock-model)
...
| Componentes         | Hospedagem de agente no AgentCore Runtime. Usando Strands Agent e Modelo Amazon Bedrock |
