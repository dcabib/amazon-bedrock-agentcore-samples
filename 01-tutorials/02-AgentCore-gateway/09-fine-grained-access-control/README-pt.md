...
- [Controle de Acesso Granular com Interceptores do AgentCore Gateway usando escopos personalizados](01-fine-grained-access-control-using-custom-scopes-pt.ipynb).
