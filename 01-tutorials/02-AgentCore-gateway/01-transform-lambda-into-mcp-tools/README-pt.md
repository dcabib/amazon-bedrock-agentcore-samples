...
- [Transformar sua função AWS Lambda em ferramentas MCP com inbound auth OAuth](01-gateway-target-lambda-oauth-pt.ipynb)

- [Transformar sua função AWS Lambda em ferramentas MCP com inbound auth AWS IAM](02-gateway-target-lambda-iam-pt.ipynb)
