...
|-----------|-------------|-----------|----------|
| Strands Agent | Notas de Reunião | Assistente de reunião que rastreia decisões, itens de ação e aprende com reuniões passadas | [meeting-notes-assistant.ipynb](./meeting-notes-assistant-pt.ipynb) |
